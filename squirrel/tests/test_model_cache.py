...
class ModelCacheTestCase(TestCase):
    ...
    def test_generate_instance_key_specified(self):
        ...
        self.assertEqual("model:tests.testmodel[code=bar]", key)
    ...
    def test_set(self):
        ...
        self.assertEqual("model:tests.testmodel[pk=1]", key)
        self.assertIn("model:tests.testmodel[pk=1]", c.data)
    ...
    def test_set_by_attribute_single(self):
        ...
        self.assertEqual("model:tests.testmodel[code=bar]", key)
        self.assertIn("model:tests.testmodel[pk=1]", c.data)
        self.assertIn("model:tests.testmodel[code=bar]", c.data)
        self.assertIn(test_instance, c.data.values())
        self.assertEqual("model:tests.testmodel[pk=1]", c.data[key])

    def test_set_by_attribute_multiple(self):
        c = FakeCache()
        key = model_cache.set_by_attribute(test_instance, ('code', 'count'), c)

        self.assertEqual("model:tests.testmodel[code=bar,count=42]", key)
        self.assertIn("model:tests.testmodel[pk=1]", c.data)
        self.assertIn("model:tests.testmodel[code=bar,count=42]", c.data)
        self.assertIn(test_instance, c.data.values())
        self.assertEqual("model:tests.testmodel[pk=1]", c.data[key])

    def test_get(self):
        c = FakeCache({
            'model:tests.testmodel[pk=1]': test_instance
        })
    ...
    def test_get_by_attribute_single(self):
        c = FakeCache({
            'model:tests.testmodel[pk=1]': test_instance,
            'model:tests.testmodel[code=bar]': 'model:tests.testmodel[pk=1]',
            'model:tests.testmodel[code=bar,count=42]': 'model:tests.testmodel[pk=1]',
        })
    ...
    def test_delete(self):
        ...
        self.assertIn("model:tests.testmodel[pk=1]", c.data)
        self.assertEqual(5, c.data["model:tests.testmodel[pk=1]"])
    ...
    def test_delete_force(self):
        ...
        self.assertNotIn("model:tests.testmodel[pk=1]", c.data)
